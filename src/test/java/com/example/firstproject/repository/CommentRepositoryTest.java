...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        // Case 3: 9번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "9번 글이 없으니 댓글이 비어있음");
        }
        // Case 4: 999번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "999번 글이 없으니 댓글이 비어있음");
        }
        // Case 5: -1번 게시글의 모든 댓글 조회
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "-1번 글이 없으니 댓글이 비어있음");
        }
    }
